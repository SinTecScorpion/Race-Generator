const CACHE = 'race-generator-r5-0-12-cross-style-character-lock-v1';
  ...
  if (isNavigation) {
    event.respondWith((async () => {
      try {
        ...
        const canonical = new Request(new URL('./index.html?build=12r5-0-12-cross-style-character-lock', self.registration.scope).href, {
          method: 'GET',
