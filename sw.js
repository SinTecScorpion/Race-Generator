const CACHE = 'race-generator-r5-0-6-dual-blender-reference-v1';
  ...
  if (isNavigation) {
    event.respondWith((async () => {
      try {
        ...
        const canonical = new Request(new URL('./index.html?build=12r5-0-6-dual-blender-reference', self.registration.scope).href, {
          method: 'GET',
