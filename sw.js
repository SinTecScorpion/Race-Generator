const CACHE = 'race-generator-r5-0-17-chatgpt-compatibility-toggle-v1';
  ...
  if (isNavigation) {
    event.respondWith((async () => {
      try {
        ...
        const canonical = new Request(new URL('./index.html?build=12r5-0-17-chatgpt-compatibility-toggle', self.registration.scope).href, {
          method: 'GET',
