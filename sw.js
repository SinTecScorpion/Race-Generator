const CACHE = 'race-generator-r5-0-18-mandatory-arm-hand-views-v1';
  ...
  if (isNavigation) {
    event.respondWith((async () => {
      try {
        ...
        const canonical = new Request(new URL('./index.html?build=12r5-0-18-mandatory-arm-hand-views', self.registration.scope).href, {
          method: 'GET',
