const CACHE = 'race-generator-r5-0-20-racial-feature-variation-pass-v1';
  ...
  if (isNavigation) {
    event.respondWith((async () => {
      try {
        ...
        const canonical = new Request(new URL('./index.html?build=12r5-0-20-racial-feature-variation-pass', self.registration.scope).href, {
          method: 'GET',
