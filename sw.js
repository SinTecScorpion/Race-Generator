const CACHE = 'race-generator-r5-0-19-fixed-blender-alignment-template-v1';
  ...
  if (isNavigation) {
    event.respondWith((async () => {
      try {
        ...
        const canonical = new Request(new URL('./index.html?build=12r5-0-19-fixed-blender-alignment-template', self.registration.scope).href, {
          method: 'GET',
